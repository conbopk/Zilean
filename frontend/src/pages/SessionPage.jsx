...
export default function SessionPage() {
  ...
  const { isInitializingCall, call, channel, chatClient, streamClient } = useStreamClient(session, loadingSession, isHost, isParticipant);
                      ...
                      <div className='flex items-start justify-between mb-3'>
                        <div>
                          ...
                          <p className='text-base-content/60 mt-2'>
                            Host: {session?.host?.name || "Loading..."} • {" "} {session?.participant ? "2/2" : "1/2"} participants
                          </p>
                        </div>
